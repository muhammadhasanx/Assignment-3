...
///////////////////////////////////////////
// This class represents a 3 x 3 board
// used in pyramid game
class pyramid_board : public X_O_Board{
public:
    void display_board();
    bool is_winner();
...
///////////////////////////////////////////
// This class represents 6x7 board
// used in four in row game
...
///////////////////////////////////////////
// This class represents 5x5 board class
...
// small change in display the winner
class fiveXfive_manager :public GameManager{
public:
   fiveXfive_manager(Board*, Player* playerPtr[2]);
  void run();
};
